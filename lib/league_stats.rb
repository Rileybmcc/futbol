module LeagueStats
  ...
  def best_offense
    ...
    @teams.find { |team| team[:team_id] == (Hash[team_ids.zip(avgs)].max_by { |id, v| v })[0] }[:team_name]
  end
  ...
  def worst_offense
    ...
    @teams.find { |team| team[:team_id] == (Hash[team_ids.zip(avgs)].min_by { |id, v| v })[0] }[:team_name]
  end
